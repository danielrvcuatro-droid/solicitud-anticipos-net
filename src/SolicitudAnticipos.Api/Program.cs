...
// Integraciones con Microsoft Graph -mismo App Registration-: subida de adjuntos a SharePoint y
// envío del correo de notificación de aprobaciones (ver las secciones Graph/SharePoint/Correo más abajo).
builder.Services.AddGraph(builder.Configuration);
